...
<div class="mt-10">
    <h3 class="mb-2 text-xs">Label for new collection</h3>
    <input type="text" name="collection_label" class="border border-gray-300 p-1 w-full">
</div>
<div class="mt-10">
    <h3 class="mb-2 text-xs">Add to existing collection</h3>

...
<div class="flex gap-2">
    <span class="py-1">SGV_</span>
    <input type="text" id="collection" placeholder="10P" class="border border-gray-300 p-1 w-10">
    <span class="py-1">_</span>
    <input type="number" placeholder="1" min="0" max="99999" id="range_start" class="border border-gray-300 p-1 w-20">
    <span class="py-1">bis</span>
